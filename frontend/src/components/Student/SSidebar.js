        ...
        >
          ...
          <div style={{
            ...
            color: activeLink === item.path 
              ? (item.path === '/student/dashboard' ? '#4a6cf7' : 
                 item.path === '/student/project-status' ? '#8364e8' : 
                 item.path === '/student/updates' ? '#b54ef8' : 
                 item.path === '/student/documentation' ? '#6e98ff' :
                 item.path === '/student/discussions' ? '#9f7bff' : '#b395ff')
